...
import com.bridgelabz.lmsspringbatchproject.repository.CandidatesRepository;
...
public class SpringBatchConfig {
    ...
    private LineMapper<Candidates> lineMapper() {
        ...
        lineTokenizer.setNames("id", "cicId", "fullName", "email", "mobileNumber", "hiredDate", "degree", "aggrPer", "city", "state", "preferredJobLocation", "status", "passedOutYear", "creatorUser", "candidateStatus");
